...
public class Recipe {
    ...
    private Recipe(String name, String description, String course, ArrayList<String> ingredients, String directions, String cuisine, String url, String img) {
        this.name = name;
